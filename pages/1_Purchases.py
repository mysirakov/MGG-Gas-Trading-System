...
from database import (
    ...
    purchases_to_df, generate_id, load_invoices, save_invoices
)
...
tab1, tab2, tab3 = st.tabs(["📝 Add Purchase", "📤 Bulk Upload", "📊 View Purchases"])
...
with tab1:
    ...
    if st.button("Add Purchase", type="primary", key="add_single"):
        ...
        if existing_invoice:
            ...
            existing_invoice['remaining_amount'] = existing_invoice['total_amount'] - existing_invoice['paid_amount']
            ...
            if st.button("Import All Rows", type="primary", key="import_purchases"):
                ...
                for _, row in df.iterrows():
                    new_purchase = {
                        ...
                        "amount_sent_eur": float(row.get('amount_sent_eur', 0)),
